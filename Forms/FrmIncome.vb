...
Namespace TempleAccounting
    Partial Public Class FrmIncome
        ...
        Private Sub InitializeComponent()
            ...
            ' lblHeader
            Me.lblHeader.Text = "💰 บันทึกรายรับเงินเข้าวัด"
            Me.lblHeader.Font = New Font("Tahoma", 15.0!, FontStyle.Bold)
            Me.lblHeader.ForeColor = Color.FromArgb(120, 53, 15)
            ...
            yBase += fh + gap
            Me.lbl2.Text = "ประเภทรายรับ:" : Me.lbl2.Location = New Point(lx, yBase)
            ...
            Me.txtAmount.ForeColor = Color.FromArgb(22, 101, 52)
            ...
            Me.btnCancel.BackColor = Color.FromArgb(180, 83, 9)
